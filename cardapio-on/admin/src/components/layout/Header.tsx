...
export function Header({ onMenuClick, sidebarCollapsed }: HeaderProps) {
  ...
  const publicMenuUrl = user?.establishment?.slug
    ? `${menuBase}/${user.establishment.slug}`
    : '#'
    ...
    >
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <a
          ...
          className="hidden items-center gap-1.5 rounded-[var(--radius-md)] px-3 py-2 text-sm text-muted hover:bg-elevated hover:text-text sm:flex"
        >
